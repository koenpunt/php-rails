...
class StylesheetIncludeTag extends AssetIncludeTag{
	...
	public function asset_tag($source, $options){
		...
		return \ActionView\Helpers\TagHelper::tag("link", array_merge( array( "rel" => "stylesheet", "type" => \RMime::CSS, "media" => "screen", "href" => $this->path_to_asset($source, array('protocol' => 'request')) ), $options));
	}
