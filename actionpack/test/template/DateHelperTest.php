...
class DateHelperTest extends PHPUnit_Framework_TestCase{
	...
	public function test_time_ago_in_words_passes_include_seconds(){
		$this->assertEquals("less than 20 seconds", DateHelper::time_ago_in_words(Date::calculate('now', '-15 seconds'), array('include_seconds' => true)));
		$this->assertEquals("less than a minute", DateHelper::time_ago_in_words(Date::calculate('now', '-15 seconds'), array('include_seconds' => false)));
	}

	public function test_distance_in_words_with_time_zones(){
		$from = Time::mktime(2004, 6, 6, 21, 45, 0);
		$from_alaska = clone $from;
		$from_hawaii = clone $from;
		
		$this->assert_distance_of_time_in_words($from_alaska->in_time_zone('America/Anchorage')); # In Rails source it was: 'Alaska'
		$this->assert_distance_of_time_in_words($from_hawaii->in_time_zone('Pacific/Honolulu')); # In Rails source it was: 'Hawaii'
	}
    ...
    assert_equal("about 2 years", DateHelper::distance_of_time_in_words(start_date, end_date))

    start_date = Date.new 1982, 12, 3
  	end_date = Date.new 2010, 11, 30
    assert_equal("almost 28 years", DateHelper::distance_of_time_in_words(start_date, end_date))
    assert_equal("almost 28 years", DateHelper::distance_of_time_in_words(end_date, start_date))
	}
    ...
    $this->assertEquals("1 minute", DateHelper::distance_of_time_in_words(seconds(30)));
    $this->assertEquals("1 minute", DateHelper::distance_of_time_in_words(seconds(59)));
    $this->assertEquals("2 minutes", DateHelper::distance_of_time_in_words(seconds(119)));
    $this->assertEquals("2 minutes", DateHelper::distance_of_time_in_words(minute(1) +59 seconds));
    $this->assertEquals("3 minutes", DateHelper::distance_of_time_in_words(minute(2) +30 seconds));
    $this->assertEquals("44 minutes", DateHelper::distance_of_time_in_words(minutes(44) +29 seconds));
    $this->assertEquals("about 1 hour", DateHelper::distance_of_time_in_words(minutes(44) +30 seconds));
    $this->assertEquals("about 1 hour", DateHelper::distance_of_time_in_words(minutes(60)));

    # include seconds
    $this->assertEquals("half a minute", DateHelper::distance_of_time_in_words(seconds(39), 0, array('include_seconds' => true)));
    $this->assertEquals("less than a minute", DateHelper::distance_of_time_in_words(seconds(40), 0, array('include_seconds' => true)));
    $this->assertEquals("less than a minute", DateHelper::distance_of_time_in_words(seconds(59), 0, array('include_seconds' => true)));
    $this->assertEquals("1 minute", DateHelper::distance_of_time_in_words(seconds(60), 0, array('include_seconds' => true)));
	}

	public function test_time_ago_in_words(){
    $this->assertEquals("about 1 year", time_ago_in_words(year(1).ago -1 day));
	}
    ...
    assert_dom_equal expected, select_day(Time::mktime(2003, 8, 16, 0, 0, 0))
    ...
    assert_dom_equal expected, select_day(Time::mktime(2003, 8, 16, 0, 0, 0), :include_blank => true)
    assert_dom_equal expected, select_day(16, :include_blank => true)
	}

	public function test_select_day_nil_with_blank(){
    expected = %(<select id="date_day" name="date[day]">\n)
    ...
    assert_dom_equal expected, select_day(Time::mktime(2011, 8, 2, 0, 0, 0), :use_two_digit_numbers => true)
    ...
    assert_dom_equal expected, select_day(Time::mktime(2003, 8, 16, 0, 0, 0), {}, :class => 'selector')
	...
	public function test_select_month_nil_with_blank(){
    expected = %(<select id="date_month" name="date[month]">\n)
	...
	public function test_select_hour_nil_with_blank(){
    expected = %(<select id="date_hour" name="date[hour]">\n)
	...
	public function test_select_minute_nil_with_blank(){
    expected = %(<select id="date_minute" name="date[minute]">\n)
    expected << %(<option value=""></option>\n<option value="00">00</option>\n<option value="01">01</option>\n<option value="02">02</option>\n<option value="03">03</option>\n<option value="04">04</option>\n<option value="05">05</option>\n<option value="06">06</option>\n<option value="07">07</option>\n<option value="08">08</option>\n<option value="09">09</option>\n<option value="10">10</option>\n<option value="11">11</option>\n<option value="12">12</option>\n<option value="13">13</option>\n<option value="14">14</option>\n<option value="15">15</option>\n<option value="16">16</option>\n<option value="17">17</option>\n<option value="18">18</option>\n<option value="19">19</option>\n<option value="20">20</option>\n<option value="21">21</option>\n<option value="22">22</option>\n<option value="23">23</option>\n<option value="24">24</option>\n<option value="25">25</option>\n<option value="26">26</option>\n<option value="27">27</option>\n<option value="28">28</option>\n<option value="29">29</option>\n<option value="30">30</option>\n<option value="31">31</option>\n<option value="32">32</option>\n<option value="33">33</option>\n<option value="34">34</option>\n<option value="35">35</option>\n<option value="36">36</option>\n<option value="37">37</option>\n<option value="38">38</option>\n<option value="39">39</option>\n<option value="40">40</option>\n<option value="41">41</option>\n<option value="42">42</option>\n<option value="43">43</option>\n<option value="44">44</option>\n<option value="45">45</option>\n<option value="46">46</option>\n<option value="47">47</option>\n<option value="48">48</option>\n<option value="49">49</option>\n<option value="50">50</option>\n<option value="51">51</option>\n<option value="52">52</option>\n<option value="53">53</option>\n<option value="54">54</option>\n<option value="55">55</option>\n<option value="56">56</option>\n<option value="57">57</option>\n<option value="58">58</option>\n<option value="59">59</option>\n)
    expected << "</select>\n"
	...
	public function test_select_minute_nil_with_blank_and_step(){
    expected = %(<select id="date_minute" name="date[minute]">\n)
    expected << %(<option value=""></option>\n<option value="00">00</option>\n<option value="15">15</option>\n<option value="30">30</option>\n<option value="45">45</option>\n)
    expected << "</select>\n"
	...
	public function test_select_second_nil_with_blank(){
    expected = %(<select id="date_second" name="date[second]">\n)
    expected << %(<option value=""></option>\n<option value="00">00</option>\n<option value="01">01</option>\n<option value="02">02</option>\n<option value="03">03</option>\n<option value="04">04</option>\n<option value="05">05</option>\n<option value="06">06</option>\n<option value="07">07</option>\n<option value="08">08</option>\n<option value="09">09</option>\n<option value="10">10</option>\n<option value="11">11</option>\n<option value="12">12</option>\n<option value="13">13</option>\n<option value="14">14</option>\n<option value="15">15</option>\n<option value="16">16</option>\n<option value="17">17</option>\n<option value="18">18</option>\n<option value="19">19</option>\n<option value="20">20</option>\n<option value="21">21</option>\n<option value="22">22</option>\n<option value="23">23</option>\n<option value="24">24</option>\n<option value="25">25</option>\n<option value="26">26</option>\n<option value="27">27</option>\n<option value="28">28</option>\n<option value="29">29</option>\n<option value="30">30</option>\n<option value="31">31</option>\n<option value="32">32</option>\n<option value="33">33</option>\n<option value="34">34</option>\n<option value="35">35</option>\n<option value="36">36</option>\n<option value="37">37</option>\n<option value="38">38</option>\n<option value="39">39</option>\n<option value="40">40</option>\n<option value="41">41</option>\n<option value="42">42</option>\n<option value="43">43</option>\n<option value="44">44</option>\n<option value="45">45</option>\n<option value="46">46</option>\n<option value="47">47</option>\n<option value="48">48</option>\n<option value="49">49</option>\n<option value="50">50</option>\n<option value="51">51</option>\n<option value="52">52</option>\n<option value="53">53</option>\n<option value="54">54</option>\n<option value="55">55</option>\n<option value="56">56</option>\n<option value="57">57</option>\n<option value="58">58</option>\n<option value="59">59</option>\n)
    expected << "</select>\n"
	...
	public function test_select_date_with_nil_value_and_no_start_and_end_year(){
    expected =  %(<select id="date_first_year" name="date[first][year]">\n)
    (Date.today.year-5).upto(Date.today.year+5) { |y| expected << %(<option value="#{y}">#{y}</option>\n) }
    expected << "</select>\n"
	...
	public function test_select_datetime_with_nil_value_and_no_start_and_end_year(){
    expected =  %(<select id="date_first_year" name="date[first][year]">\n)
    (Date.today.year-5).upto(Date.today.year+5) { |y| expected << %(<option value="#{y}">#{y}</option>\n) }
    expected << "</select>\n"
	...
	public function test_date_select_with_nil(){
    @post = Post.new
	...
	public function test_date_select_with_nil_and_blank(){
    @post = Post.new
	...
	public function test_date_select_with_nil_and_blank_and_order(){
    @post = Post.new
	...
	public function test_date_select_with_nil_and_blank_and_discard_month(){
    @post = Post.new
	...
	public function test_date_select_with_nil_and_blank_and_discard_year(){
    @post = Post.new
	...
	public function test_date_select_with_nil_value_and_no_start_and_end_year(){
    expected =  %(<select id="date_first_year" name="date[first][year]">\n)
    (Date.today.year-5).upto(Date.today.year+5) { |y| expected << %(<option value="#{y}">#{y}</option>\n) }
    expected << "</select>\n"
	...
	public function test_datetime_select_with_nil_value_and_no_start_and_end_year(){
    expected =  %(<select id="date_first_year" name="date[first][year]">\n)
    (Date.today.year-5).upto(Date.today.year+5) { |y| expected << %(<option value="#{y}">#{y}</option>\n) }
    expected << "</select>\n"
