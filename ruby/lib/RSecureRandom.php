...
class RSecureRandom{
	...
	public static function random_bytes($len=null){
		...
		trigger_error("No random device", E_USER_ERROR);
	}
	...
	public static function base64($n=null){
	...
	public static function urlsafe_base64($n=nil, $padding=false){
	...
	public static function uuid(){
		...
		return vsprintf("%08x-%04x-%04x-%04x-%04x%08x", $ary);
	}
}